...
// ════════════════════════════════════════════════════════════════════════════════
// ABSORBED: allBusSccButtonInjector.js
// Injects All-Bus SCC Steps and Export buttons into #resultsContainer after
// each displayCalculationResults() call, retrying until the function is available.
// ════════════════════════════════════════════════════════════════════════════════
