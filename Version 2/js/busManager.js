            ...
            <div style="padding: 10px; border: 1px solid #e0e0e0; border-radius: 5px; margin-top: 5px;">
                <div class="form-group">
                    <label for="editBusDemandFactor">
                        ...
                        <span class="tooltip">ℹ️
                            <span class="tooltiptext">Ratio of actual load to connected load. NEC Article 220. Default: 1.0 (100%). Example: 0.85 for 85% demand.</span>
                        </span>
                    </label>
                ...
                <div class="form-group">
                    <label for="editBusDiversityFactor">
                        ...
                        <span class="tooltip">ℹ️
                            <span class="tooltiptext">Ratio of simultaneous load to maximum load. IEEE 141. Leave blank for automatic based on bus type.</span>
                        </span>
                    </label>
                    <input type="number" id="editBusDiversityFactor" value="${bus.diversityFactor || ''}" step="0.01" min="0" max="1" placeholder="Auto">
                    <small style="color: #666; font-size: 0.85em;">IEEE 141 - Diversity factors. Auto: Source=90%, Distribution=85%, Branch=80%</small>
                </div>
            </div>
        </details>
