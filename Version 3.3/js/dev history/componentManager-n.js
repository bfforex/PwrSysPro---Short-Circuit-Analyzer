    ...
    if (type === 'transformer') {
        html = `
            <div class="form-group">
                <label for="transformerRating">Rating (kVA):</label>
            ...
            <!-- ✅ FEATURE: Transformer Tap Setting (Issue #2 Enhancement) -->
            <div class="form-group">
                <label for="transformerTapSetting">
                    Tap Setting (%):
                    <span class="tooltip">ℹ️
                        <span class="tooltiptext">Adjust secondary voltage ±5% to compensate for voltage drop. Common taps: +2.5% or +5% boost low voltage, -2.5% or -5% reduce high voltage. Leave at 0% for nominal operation.</span>
                    </span>
                </label>
...
function addComponent() {
    ...
    if (type === 'cable') {
        ...
        const tapSetting = parseFloat(document.getElementById('transformerTapSetting')?.value) || 0;  // ✅ NEW
        ...
        component = {
            ...
            impedance: impedance,
            xr: xr,
            tapSetting: tapSetting,  // ✅ NEW: Store tap setting
            name: `${rating} kVA Transformer (${primary}V / ${secondary}V)`
        };
